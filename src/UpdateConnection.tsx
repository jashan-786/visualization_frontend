...
export const UpdateConnection = () => {
  ...
  const onClickHandler = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    const newPhone = newPhoneRef.current ? newPhoneRef.current.value : "";
    ...
    <div className="flex flex-col min-h-screen">
      ...
      {localStorage.getItem("token") ? (
        <div className="flex-1 bg-gray-100 p-3 sm:p-6 md:p-12 flex items-center justify-center">
          <div className="w-full max-w-[320px] sm:max-w-[480px] md:max-w-[580px] bg-white rounded-lg shadow-lg">
              ...
              <div className="flex flex-col space-y-4 sm:space-y-6">
                ...
                <form className="space-y-4 sm:space-y-6">
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <>
                      <div className="  flex  items-center center gap-3 align-middle">
                    ...
                    {showExtraUser1Fields.description && (
                      <div className="relative">
                        <textarea
                          ref={descriptionRef}
